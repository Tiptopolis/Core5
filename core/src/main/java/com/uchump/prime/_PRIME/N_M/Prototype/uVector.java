package com.uchump.prime._PRIME.N_M.Prototype;
...
public class uVector extends aVector<Number> {
	...
	public static aVector<Number> Byte(int b) {
		return new com.uchump.prime._PRIME.N_M.NIX.Binary(b);
	}
	...
	public static aVector<Number> Hex(byte h) {
		return new com.uchump.prime._PRIME.N_M.NIX.Hex((int) h);
	}

	public static aVector<Number> Hex(int h) {
		return new com.uchump.prime._PRIME.N_M.NIX.Hex(h);
	}
