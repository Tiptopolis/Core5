package com.uchump.prime.TEST.sTest2.tstEnv;
...
public class Env2 extends _Environment{
	...
	public void update(float deltaTime) {
		...
		Rect r = CAMERA.getViewRect();
		
		//Vector3 curAt = this.observer.Camera.camera.unproject(new Vector3(MouseX, MouseY, 1));
		Vector3 curAt = new Vector3(MouseX, MouseY, 1);
		Vector3 camAt = this.observer.Camera.camera.unproject(new Vector3(r.width / 2, r.height / 2, 0));
