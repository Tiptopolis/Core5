...
import com.uchump.prime.TEST.sTest1.tstEnv.Env1;
...
public class ShaderTest9_BS1 extends uApp {
	...
	public void create() {
		...
		String path = "/assets/TST/SHD/BoundShape/BSa_1_Y3";
		//String path = "/assets/TST/SHD/BoundShape/BS_9_Y3";
	...
	public void render() {
		...
		Sketcher.Drawer.filledRectangle(0, 0, Width*3, Height*3);
		Sketcher.end();
	...
	{
		this.environment.size = new Vector3(Width*3, Height*3,1);
	}
