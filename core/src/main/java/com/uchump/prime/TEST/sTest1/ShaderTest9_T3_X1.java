...
public class ShaderTest9_T3_X1 extends uApp {
	...
	public void create() {
		...
		String path = "/assets/TST/SHD/BoundShape/Y3";
	...
	public void update(float deltaTime) {
		...
		//shader.setUniformf("u_mouse", new Vector2(MouseX,MouseY));	
	...
	public void render() {
		...
		Sketcher.Drawer.filledRectangle(-Width, -Height, Width*3, Height*3);
		Sketcher.end();
