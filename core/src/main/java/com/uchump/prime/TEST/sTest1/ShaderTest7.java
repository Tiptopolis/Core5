...
public class ShaderTest7 extends uApp {
	...
	public void create() {
		...
		String path = "/assets/TST/SHD/BoundShape/W1";
	...
	public void update(float deltaTime) {
		...
		//shader.setUniformf("u_camP", CAMERA.Camera.camera.unproject(CAMERA.getCameraPosition().cpy()));
